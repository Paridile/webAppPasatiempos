 ...
 String fechaAdquisicion;
    ...
    public void devolverPaginaHTML(HttpServletResponse response) {
        ...
        try (PrintWriter out = response.getWriter()) {            
            ...
            out.println("    <title>Respuesta de inserción de persona mascota</title>");
            out.println(" </head>");
            out.println(" <body style=\"background-color: #eeeeee;\">");
            out.println("     <section>");
            out.println("         <h2 class=\"display-4 container mb-3 pt-5 text-success text-center\">Los datos de la relación persona - mascota han sido registrados correctamente</h2>");
            ...
            out.println("               <a href=\"reportePersonaMascota.jsp\" >");
            out.println("                   <button type=\"button\" class=\"btn btn-info btn-lg btn-block\">Ver reporte de persona mascota</button>");
            out.println("               </a>                                    ");
            out.println("           </div>");
            out.println("           <div class=\"col-4\">");
